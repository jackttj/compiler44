...
namespace frontend
{
    ...
    struct Analyzer
    {
        vector<int> index_of_goto;
        vector<int> index_for_continue;
        int tmp_cnt; // start from 0 , just like the memery index
        vector<ir::Instruction *> g_init_inst;
        SymbolTable symbol_table;
        ir::Function global_function;
        /**
         * @brief constructor
         */
        Analyzer();
        ...
        void analysisDecl(Decl *root, std::vector<ir::GlobalVal> &vc);
        void analysisDecl(Decl *root, std::vector<ir::Instruction *> &ins);
        ...
        void analysisBlock(Block *root, frontend::ScopeInfo &);
        void analysisBlock(Block *root, vector<ir::Instruction *> &);
        void analysisMulExp(MulExp *root, vector<ir::Instruction *> &);
        void analysisUnaryExp(UnaryExp *root, vector<ir::Instruction *> &);
        void analysisPrimaryExp(PrimaryExp *root, vector<ir::Instruction *> &vc);
        void analysisLorExp(LOrExp *root, vector<ir::Instruction *> &vc);
        void analysisLAndExp(LAndExp *root, vector<ir::Instruction *> &vc);
        void analysisEqExp(EqExp *root, vector<ir::Instruction *> &vc);
        void analysisRelExp(RelExp *root, vector<ir::Instruction *> &vc);
        void analysisConstExp(ConstExp *root, vector<ir::Instruction *> &vc);
        void analysisConstIniVal(ConstInitVal *root, vector<ir::Instruction *> &vc);
        void analysisInitialval(InitVal *root, vector<ir::Instruction *> &vc);
